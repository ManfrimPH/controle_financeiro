...
def first_quest_del(message, finance_bot):
    ...
    markup.add(
        types.InlineKeyboardButton(
            "Gasto", callback_data="local_spent"
        ),
        types.InlineKeyboardButton(
            "Ganho", callback_data="local_gain"
        ),
    )
...
def third_quest_del(call, finance_bot):
    ...
    if resp == "Sim":
        ...
        if resp_del == True:
            ...
            finance_bot.bot.send_message(chat_id, "Erro ao Deletar!", parse_mode="Markdown")
