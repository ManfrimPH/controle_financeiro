...
def first_quest(message, finance_bot):
    ...
    markup.add(
        types.InlineKeyboardButton("Ganhei Dinheiro", callback_data="gain_entry_type_Ganho"),
        types.InlineKeyboardButton("Gastei Dinheiro", callback_data="spent_entry_type_Gasto"),
    )
...
def second_quest_gain(call, finance_bot):
    ...
    markup.add(
        types.InlineKeyboardButton("Gastos Fixos", callback_data="gain_category_Gastos Fixos"),
        types.InlineKeyboardButton("Estilo de Vida", callback_data="gain_category_Estilo de Vida"),
        types.InlineKeyboardButton(
            "Investimento e Projetos", callback_data="gain_category_Investimento e Projetos"
        ),
        types.InlineKeyboardButton(
            "Besteiras", callback_data="gain_category_Besteiras"
        ),
        types.InlineKeyboardButton(
            "Presente", callback_data="gain_category_Presente"
        ),
    )
...
def second_quest_spent(call, finance_bot):
    ...
    markup = types.InlineKeyboardMarkup()
    markup.add(
        types.InlineKeyboardButton("Gastos Fixos", callback_data="spent_category_Gastos Fixos"),
        types.InlineKeyboardButton(
            "Renda Extra", callback_data="spent_category_Renda Extra"
        ),
        types.InlineKeyboardButton(
            "Investimento", callback_data="spent_category_Investimento"
        ),
        types.InlineKeyboardButton(
            "Lazer", callback_data="spent_category_Lazer"
        ),
    )
...
def third_quest_spent(call, finance_bot):
    ...
    markup = types.InlineKeyboardMarkup()
    markup.add(
        types.InlineKeyboardButton("Debito", callback_data="spent_payment_method_Debito"),
...
def fourth_quest_spent(call, finance_bot):
    chat_id = call.message.chat.id
    chat_data[chat_id]["payment_method"] = call.data.replace("spent_payment_method_", "")
