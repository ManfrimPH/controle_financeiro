...
def first_quest(message, finance_bot):
  ...
  finance_bot.send_message(chat_id, '**Novo registro!!** \n O que você fez com seu dinheiro dessa vez?', reply_markup=markup, parse_mode='Markdown')

## Gain Format

def second_quest_gain(call, finance_bot):
  chat_id = call.message.chat.id
  chat_data[chat_id]['entry_type'] = 